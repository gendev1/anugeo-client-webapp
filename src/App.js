...
function App() {
    ...
    const handleLogin = async (userData) => {
        try {
            const res = await axios.post('http://localhost:2000/auth/login', userData);
    ...
    const handleEditUser = async (userData) => {
        try {
            ...
            const res = await axios.put(`http://localhost:2000/users/${id}`, userData, {
                headers,
            });
    ...
    const handleGetAllWorksByUser = async () => {
        ...
        axios
            ...
            .then((response) => {
                setCurrWorks(response.data.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt)));
    ...
    return (
        <>
            ...
            <Routes>
                ...
                <Route path="/work" element={<WorkOrder handleWorkOrder={handleWorkOrder} />} />
                <Route path="/profile" element={<Profile handleEditUser={handleEditUser} />} />
                <Route path="/user-order" element={<UserOrders handleGetAllWorksByUser={handleGetAllWorksByUser} currWorks={currWorks} />} />
                <Route path="/progress" element={<Progress handleGetAllWorksByUser={handleGetAllWorksByUser} currWorks={currWorks} setCurrWorks={setCurrWorks} />} />
            </Routes>
        </>
    );
}
